...
> **This is a Devpost-paste mirror of the root [`README.md`](https://github.com/iarjunganesh/bankers-wrapped/blob/main/README.md).**
...
> file's content directly into the Devpost form and every link/image still resolves. Generated by
> rewriting the root README; if you edit the README, regenerate this file rather than hand-editing
> it (see the version-sync policy in `CLAUDE.md`) so the two never drift apart.
...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/iarjunganesh/bankers-wrapped/blob/main/LICENSE) [![Watch Video](https://img.shields.io/badge/%E2%96%B6_Watch-3--min_demo-FF0000?logo=youtube&logoColor=white)](#)
...
Eleven decisions documented (001–011), **all accepted and implemented** — see [`docs/adr/`](https://github.com/iarjunganesh/bankers-wrapped/tree/main/docs/adr) for full rationale.
